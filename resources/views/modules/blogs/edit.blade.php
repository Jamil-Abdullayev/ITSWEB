                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="col s12" id="account">
                                        ...
                                        <form id="accountForm" method="POST" action="{{route('users.update',$user->id)}}">
                                            @csrf
                                            @method('PATCH')
                                            <div class="row">
                                                <div class="col s12 m6">
                                                    <div class="row">
                                                        <div class="col s12 input-field">
                                                            <input required id="name" name="name" type="text" class="validate" value="{{$user->name}}" data-error=".errorTxt2">
                                                            <label for="name">Name</label>
                                                            <small class="errorTxt2"></small>
                                                        </div>
                                                        <div class="col s12 input-field">
                                                            <input required id="email" name="email" type="email" class="validate" value="{{$user->email}}" data-error=".errorTxt3">
